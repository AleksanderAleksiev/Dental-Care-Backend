# Dentalcare
 ...
 Actually, this is only the server side of the application which handles the API requests and storing the data in a database. It can be paired with various UI applications, but I have chosen React.
...
For this part of the application I have used **Node.js** with the well known **Express** framework pairing it with **MySQL** database.